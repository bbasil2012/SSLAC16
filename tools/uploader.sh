...
#    curl http://$addr/rest?ch=$i&max=$j
    curl -s 'http://192.168.4.1/set?tp='$i'&=sunrise&=7&=0' >/dev/null
    curl -s 'http://192.168.4.1/set?tp='$i'&=day&=9&=0' >/dev/null
    curl -s 'http://192.168.4.1/set?tp='$i'&=sunset&=21&=0' >/dev/null
    curl -s 'http://192.168.4.1/set?tp='$i'&=night&=23&=0' >/dev/null
    curl -s 'http://192.168.4.1/set?ch='$i'&desc=Channel_'$i >/dev/null
